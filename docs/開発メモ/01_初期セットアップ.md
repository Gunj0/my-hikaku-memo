...
## Cloudflare Workers ドキュメントに従って pnpm でセットアップ
...
──────────────────────────────────────────────────────────────────────────────────────────────────────────
👋 Welcome to create-cloudflare v2.61.0!
🧡 Let's get started.
...
+ First Load JS shared by all             102 kB
  ├ chunks/149-93a3163657730b7b.js       45.6 kB
  ├ chunks/70e20838-8e10520aa36b998b.js  54.2 kB
...
✨ Read 38 files from the assets directory {project-path}/.open-next/assets
...
✨ Success! Uploaded 28 files (2.20 sec)
...
│ deployment is ready at: https://{project-url}
│
├ Opening browser
│
╰ Done
...
Using vars defined in .dev.vars
Using vars defined in .dev.vars
 ✓ Compiled successfully in 827ms
 ✓ Linting and checking validity of types
 ✓ Collecting page data
 ✓ Generating static pages (4/4)
 ✓ Collecting build traces
